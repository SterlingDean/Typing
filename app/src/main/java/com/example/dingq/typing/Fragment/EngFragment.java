 ...
 * Use the {@link EngFragment#newInstance} factory method to
...
public class EngFragment extends Fragment {
    ...
    public static EngFragment newInstance(String param1, String param2) {
        EngFragment fragment = new EngFragment();
